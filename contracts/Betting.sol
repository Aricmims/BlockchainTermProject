...
contract Betting {
	...
	function validBet(address _bettorAddress) view public returns (bool) {
	...
	function insert(address _bettorAddress) {
		if(numElements == players.length) {
			players.length += 1;
		}
		players[numElements++] = _bettorAddress;
	}
...
/*
From: https://medium.com/coinmonks/create-a-sports-betting-dapp-on-the-ethereum-blockchain-part-1-1f69f908b939
